	...
	return (
		<main className="min-h-screen py-12 px-4 flex justify-center">
			<div className="max-w-md w-full space-y-16 mx-auto">
				<section id="home">
					<h1 className="font-semibold">Luiz Henrique</h1>
					<h2 className="text-sm text-neutral-400">Software Engineer</h2>
				</section>
						...
						{WORK_EXPERIENCE.map((work) => (
							<div className="flex justify-between" key={work.company}>
								<div className="flex items-start gap-4">
									<div className="size-8 bg-neutral-800 relative rounded-sm overflow-hidden border border-neutral-700">
										<Image
											src={work.icon}
											alt={work.company}
									...
									<div className="space-y-1">
										<div className="flex items-center gap-2">
											<h3 className="text-sm font-medium">{work.company}</h3>
										</div>

										<p className="text-xs text-neutral-400">{work.role}</p>
									</div>
								</div>
